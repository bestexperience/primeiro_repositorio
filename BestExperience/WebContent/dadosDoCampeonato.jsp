...
<div class="container">
 <div class="card">
  ...
  <div class="card">
        <div class="card-header" id="headingTwo">
          <h5 class="mb-0">
            <button class="btn btn-primary btn-lg btn-block" data-toggle="collapse" data-target="#cartoesMaster" aria-expanded="false" aria-controls="golsMaster">
              Cartões Master
            </button>
          </h5>
        </div>
        <div id="cartoesMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
          <div class="card-body">
            <div class="jumbotron text-center">
        <h1>Artilharia</h1>
        <h2>Categoria: Master</h2> 
  ...
  <div class="card">
        <div class="card-header" id="headingTwo">
          <h5 class="mb-0">
            <button class="btn btn-primary btn-lg btn-block" data-toggle="collapse" data-target="#cartoesSenior" aria-expanded="false" aria-controls="golsMaster">
              Cartões Sênior
            </button>
          </h5>
        </div>
        <div id="cartoesSenior" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
          <div class="card-body">
            <div class="jumbotron text-center">
        <h1>Artilharia</h1>
        <h2>Categoria: Master</h2> 
